...
df=pd.read_csv("/path/no_h_bond.csv")
...
if p_value < 0.05:
    ...
    print(tukey)
    # Extract significant differential pairs
...
plt.title('Comparison of Hydrogen Bonds Number')
plt.xlabel('Group')
plt.ylabel('NHB')
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("/path/no_h_bond_violin.png", dpi=300, bbox_inches='tight')
plt.show()
